    ...
    <>
      ...
      {showPicker && createPortal(
        <div
          ...
          className={`transition-all duration-200 ease-in-out bg-white rounded-2xl shadow-xl border-4 border-blue-100 ${
                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      ${!day ? "invisible" : ""}
                      ${isDisabledDate ? "text-gray-300 cursor-not-allowed" : "hover:bg-blue-100"}
