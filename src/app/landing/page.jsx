  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-400 via-green-300 to-yellow-200">
      ...
      <main className="pt-20">
        <section className="hero min-h-screen flex items-center justify-center text-center px-4">
          <div className="container mx-auto" data-aos="zoom-in">
            ...
            <button className="bg-theme-color-secondary text-white px-8 py-4 rounded-full text-xl font-bold hover:bg-theme-color-secondary-dark transform hover:scale-105 transition-all">
              Đặt Ngay!
            </button>
          </div>
        </section>
        ...
        <section className="bg-white py-20 px-4">
          <div className="container mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12" data-aos="fade-up">Tại Sao Chọn ColorGo?</h2>
            <div className="grid md:grid-cols-4 gap-8">
              <div className="bg-gradient-to-br from-blue-50 to-green-50 p-6 rounded-xl shadow-[0_0_20px_rgba(59,130,246,0.5)]" data-aos="fade-right">
                <FaPlane className="text-5xl text-theme-color-primary mb-4" />
                <h3 className="text-xl font-bold mb-2">Giá Tốt Nhất</h3>
                <p>Đảm bảo giá thấp nhất trên mọi tuyến đường với cam kết về giá.</p>
              </div>
              <div className="bg-gradient-to-br from-green-50 to-yellow-50 p-6 rounded-xl shadow-[0_0_20px_rgba(52,211,153,0.5)]" data-aos="fade-up">
                <FaGift className="text-5xl text-theme-color-secondary mb-4" />
                <h3 className="text-xl font-bold mb-2">Ưu Đãi Đặc Biệt</h3>
                <p>Giảm giá thường xuyên và nhiều ưu đãi cho khách hàng thân thiết.</p>
              </div>
              <div className="bg-gradient-to-br from-yellow-50 to-blue-50 p-6 rounded-xl shadow-[0_0_20px_rgba(251,191,36,0.5)]" data-aos="fade-left">
                ...
                <p>Hỗ trợ khách hàng xuyên suốt cho mọi nhu cầu du lịch của bạn.</p>
              </div>
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl shadow-[0_0_20px_rgba(147,51,234,0.5)]" data-aos="fade-left">
                ...
                <h3 className="text-xl font-bold mb-2">An Toàn Trên Từng Chặng Đường</h3>
                <p>Đảm bảo an toàn tối đa cho mọi hành trình của bạn.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4 bg-gray-50">
          <div className="container mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12" data-aos="fade-up">Tuyến Đường Phổ Biến</h2>
            <div className="grid md:grid-cols-3 gap-8">
              {popularRoutes.map((route, index) => (
                <div key={index} className="bg-white rounded-xl overflow-hidden shadow-[0_0_20px_rgba(59,130,246,0.3)] hover:shadow-[0_0_30px_rgba(59,130,246,0.5)] transition-shadow" data-aos="flip-left" data-aos-delay={index * 100}>
                  <img src={route.image} alt={`${route.from} đến ${route.to}`} className="w-full h-48 object-cover" />
                  <div className="p-6">
                    <h3 className="text-xl font-bold mb-2">{route.from} → {route.to}</h3>
                    <p className="text-2xl font-bold text-theme-color-primary">{route.price}</p>
                    <button className="mt-4 w-full bg-theme-color-primary text-white py-2 rounded-full hover:bg-theme-color-primary-dark transition-colors">
                      Đặt Ngay
                    </button>
                  </div>
                </div>
        ...
        <section className="py-20 px-4 bg-white">
          <div className="container mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12" data-aos="fade-up">Ưu Đãi Đặc Biệt</h2>
            <div className="grid md:grid-cols-3 gap-8">
              {specialOffers.map((offer, index) => (
                <div key={offer.id} className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl overflow-hidden shadow-[0_0_20px_rgba(99,102,241,0.3)] hover:shadow-[0_0_30px_rgba(99,102,241,0.5)] transition-all duration-300" data-aos="flip-up" data-aos-delay={index * 100}>
                  ...
                  <div className="p-6">
                    ...
                    <button className="mt-4 w-full bg-theme-color-primary text-white py-2 rounded-full hover:bg-theme-color-primary-dark transition-colors flex items-center justify-center">
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12" data-aos="fade-up">Khách Hàng Nói Gì?</h2>
            <div className="grid md:grid-cols-3 gap-8">
              {testimonials.map((testimonial, index) => (
                <div key={testimonial.id} className="bg-white p-6 rounded-xl shadow-[0_0_20px_rgba(59,130,246,0.3)] hover:shadow-[0_0_30px_rgba(59,130,246,0.5)]" data-aos="zoom-in-up" data-aos-delay={index * 100}>
      ...
      <footer className="bg-gray-800 text-white py-12 px-4">
        <div className="container mx-auto grid md:grid-cols-4 gap-8" data-aos="fade-up">
          <div>
            <h3 className="text-xl font-bold mb-4">ColorGo</h3>
            <p>Mang đến trải nghiệm du lịch đầy màu sắc cho mọi người.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p>Email: info@colorgo.com</p>
            <p>Điện thoại: +84 234 567 890</p>
          </div>
          <div>
        ...
        <div className="container mx-auto mt-8 pt-8 border-t border-gray-700 text-center">
          <p>© 2024 ColorGo. Đã đăng ký bản quyền.</p>
        </div>
      </footer>
    </div>
  );
